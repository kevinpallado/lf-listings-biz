...
async function findOne(value: Params) {
    ...
    const { data } = await fetchAPI(`/listings/property/offmarket/${value.id}`)
                        ...
                        <div className="xl:flex xl:space-x-10 2xl:space-x-16">
                            <div className="flex-1 min-w-0">
                                ...
                                {process.env.SHOW_COMMISSION === "true" ? <section id="commission" className="mb-5">
                                    ...
                                    <div>
                                        <a className="no-underline hover:underline text-blue-600" href={`${process.env.BIZ_URL}/offmarket/${params.id}`} target="_blank">Click the here to see buyer broker cooperating details</a>
                                    </div>
                                </section>}
